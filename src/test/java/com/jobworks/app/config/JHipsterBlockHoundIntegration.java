package com.jobworks.app.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jobworks.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jobworks.app.security.DomainUserDetailsService", "createSpringSecurityUser");
